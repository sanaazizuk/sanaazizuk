<!-- Banner Image -->
<p align="center">
  <img src="https://github.com/sanaazizuk/sanaazizuk/blob/main/Sana_GitHub_Banner_Typing(1).gif" width="100%">
</p>
...
End to end projects where I've handled everything from raw data to final output, covering cleaning, analysis, and visualisation.
...
*Thanks for stopping by — feel free to explore the projects or reach out if you'd like to connect.*
